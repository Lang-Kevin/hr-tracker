...
Cohesion: 0.13
Nodes (10): BluetoothDevice, Boolean, ConnectionState, DiscoveredDevice, List, Long, SavedDevice, StateFlow (+2 more)
...
Cohesion: 0.16
Nodes (9): Flow, Int, Job, List, Long, ParsedHr, StateFlow, String (+1 more)

### Community 14 - "Community 14"
Cohesion: 0.27
Nodes (13): Boolean, List, Long, Session, String, durationString(), HistoryScreen(), SessionListItem() (+5 more)
...
Cohesion: 0.27
Nodes (10): DiscoveredDevice, SavedDevice, String, BrandHint(), DeviceItem(), SavedDeviceItem(), ScanScreen(), SmartWatchHelpDialog() (+2 more)
...
## Knowledge Gaps
- **137 isolated node(s):** `Long`, `Bundle`, `String`, `ByteArray`, `StateFlow` (+132 more)
...
- **Why does `HistoryViewModel` connect `Community 9` to `Community 7`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **What connects `Long`, `Bundle`, `String` to the rest of the system?**
