...
**Onboarding-Text nachgezogen:**
Schritt 3 des Onboardings versprach „genauere Zonen-Berechnungen nach der Karvonen-Formel" für den Ruhepuls. Seit dem neuen Default `HR_MAX` stimmte das nicht mehr — ein Fresh Install mit eingetragenem Ruhepuls landet auf %HRmax. Text sagt jetzt, dass der Ruhepuls für das optional wählbare Karvonen-Modell gebraucht wird und %HRmax der Standard bleibt. Gefunden bei der Geräte-Verifikation auf einem frisch installierten Fire-Tablet (`OnboardingScreen.kt:196`).
...
**Betroffene Dateien:**
- `HrZoneCalculator.kt`, `UserSettings.kt`, `SettingsRepository.kt`, `SessionRepository.kt`, `ScanViewModel.kt`, `HrRecordingService.kt`, `LiveViewModel.kt`, `HrSampleDao.kt`, `SettingsViewModel.kt`, `SettingsScreen.kt`, `OnboardingScreen.kt`, `HrZoneCalculatorTest.kt`
