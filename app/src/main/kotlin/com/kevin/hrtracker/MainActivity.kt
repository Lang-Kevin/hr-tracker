...
import com.kevin.hrtracker.ui.live.LiveViewModel
...
class MainActivity : ComponentActivity() {
    ...
    private fun HrTrackerNav() {
        ...
        // Navigate to live screen when a session becomes active
        ...
        NavHost(navController = navController, startDestination = Route.SCAN) {
            composable(Route.SCAN) {
                ScanScreen(viewModel = scanViewModel, onSessionStarted = {
                    startRecordingService(it)
                })
            }
